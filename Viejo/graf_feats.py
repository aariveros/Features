...
# # ########## Eta #############
# x_values, y_values, completitud = st.get_feat_and_comp(curva, ft.eta, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Eta', x_values[2:], completitud, 3)


# # ######### Con #############
# x_values, y_values, completitud = st.get_feat_and_comp(curva, ft.con, lu.var_completeness)
...
# x_values, y_values, completitud = st.get_feat_and_comp(curva, ft.B_R, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'B-R', x_values[2:], completitud, 6)


# ######### Stetson L ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva, ft.stetsonL, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Stetson-L', x_values[2:], completitud, 7)


# ######### Stetson J ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva, ft.stetsonJ, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Stetson-J', x_values[2:], completitud, 8)


# ######### Stetson K ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.stetsonK, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Stetson-K', x_values[2:], completitud, 9)


# # ######### Skew ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.skew, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Skewness', x_values[2:], completitud, 10)


# # ######### Kurtosis ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.small_kurtosis, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Kurtosis', x_values[2:], completitud, 10)


# ######### Standar deviation ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.std, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Standar deviation', x_values[2:], completitud, 10)


# ######### Beyond 1 std ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.beyond1_std, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Beyond 1 std', x_values[2:], completitud, 10)


# ######### Max slope ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.max_slope, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Max slope', x_values[2:], completitud, 10)


# ######### Amplitude ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.amplitude, lu.var_completeness, 10)
# io.graf_feature( x_values, y_values, 'Amplitud', x_values[2:], completitud, 10)

# ######### Median abs dev ##########
# x_values, y_values, completitud = st.get_feat_and_comp(curva['azul'], ft.median_abs_dev, lu.var_completeness, 10)
